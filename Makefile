...
LUA_CLIB_SKYNET = \
  ...
  lua-multicast.c \
  lua-cluster.c \
  lua-crypt.c lsha1.c hmac_sha256.c sha256.c\
  lua-sharedata.c \
  lua-stm.c \
  lua-debugchannel.c \
  lua-datasheet.c \
...
$(LUA_CLIB_PATH)/client.so : lualib-src/lua-clientsocket.c lualib-src/lua-crypt.c lualib-src/lsha1.c lualib-src/hmac_sha256.c lualib-src/sha256.c | $(LUA_CLIB_PATH)
